                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" id="name" name="name" required max="255" value="{{ old('name') ?? $tryout->name ?? "" }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="input-group col-md-10">
                                <input type="number" class="form-control" id="duration" name="duration" min="1" required value="{{ old('duration') ?? $tryout->duration ?? "" }}">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-10">
                                <input class="input-range form-control" type="text" name="range" value="{{ old('duration') ?? $tryout->range ?? "" }}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="input-group col-md-10">
                                ...
                                <input type="number" class="form-control" id="price" name="price" required value="{{ old('price') ?? $tryout->price ?? "" }}">
                            </div>
                        </div>
